...
const subnetear = () =>{
    ...
    if(octeto1.value >=0 && octeto1.value <= 127){
        ...
        if(salto >=9 && salto<=16){
            htm = subredes.map((t)=>{
                return "<tr>" + "<td> Subred: " + red.octetor1+'.'+red.octetor2+'.'+red.octetor3+'.'+t+"</td>" + "<td> Hosts x subred:" + hosts +"</td>" + "<tr>"
            });
        }else if(salto>=17){
            //htm = subredes.map((t)=>{
            ...
            htm = subredes.map((t)=>{
               return "<tr>" + "<td> Subred: " + red.octetor1+'.' + red.octetor2 +'.'+t+'.'+red.octetor4+"</td>" + "<td> Hosts x subred:" + hosts +"</td>" + "<tr>"
            });
        }
        console.log(htm);
        tabla.innerHTML = htm.join("");
